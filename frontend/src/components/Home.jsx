...
const Home = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col gap-y-4 bg-gradient-to-bl from-violet-200 via-blue-100 to-cyan-200">

      <div className="sticky top-0 z-50 bg-white/80 backdrop-blur-md px-14 items-center h-16 w-full border-b border-gray-400 flex justify-between">
        ...
        <div className="flex gap-x-2 items-center">
          ...
          <div className="h-full px-6 border-x border-gray-400">
            <Button
              size="md"
              className="transform transition hover:scale-105 rounded-full text-md font-semibold px-8 cursor-pointer"
          ...
          <Button
            className="items-center justify-center rounded-full ml-2 flex text-sm font-semibold border-gray-500 text-gray-600 hover:bg-blue-100 hover:border-blue-400 hover:text-blue-600 transform transition hover:scale-105 cursor-pointer"
            size="md"
            variant="outline"
      ...
      <div className="relative py-24 flex h-[60vh] w-full px-[10%] justify-between">
        ...
        <div className="relative w-[45%] flex flex-col h-full items-center justify-center">
          <h1 className="text-6xl flex font-bold">
            <p className="mr-2 text-blue-700">Unlock</p> Your Fitness
          </h1>
          <p className="text-center pt-2 text-gray-500 text-lg flex flex-wrap w-[70%]">
