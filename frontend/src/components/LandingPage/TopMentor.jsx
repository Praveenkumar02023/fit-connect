    ...
    <div className="pt-48 px-14 py-10 w-full">
      ...
      <div className="flex justify-between items-center mb-6 w-full ">
        <div className="flex flex-col items-center w-full " >
          <h2 className="text-4xl font-bold"><span className="text-blue-700">Top</span> Mentors</h2>
          <p className="text-md text-gray-500">
            In search of excellence? Explore the highest-rated mentors as recognized by the community.
          </p>
        </div>
      </div >
       ...
       <div className="flex justify-center items-center">
        ...
        <div className="px-12" >
          <ArrowLeft onClick={() => scroll("left")} className="border rounded-full cursor-pointer hover:border-gray-200 hover:bg-gray-100"/>
        </div>
      ...
      <div className="px-12">
          <ArrowRight onClick={() => scroll("right")} className="border rounded-full cursor-pointer hover:border-gray-200 hover:bg-gray-100" />
      </div>
