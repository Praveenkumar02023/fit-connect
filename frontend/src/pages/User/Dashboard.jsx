    ...
    <div className="relative min-h-screen w-full bg-gradient-to-br from-blue-50 via-white to-blue-100 pt-5">
      ...
      <div className="absolute inset-0 overflow-hidden z-10 pointer-events-none">
        {[
          ...
          ["bottom-[15%]", "right-[5%]", "w-56", "h-56", "bg-yellow-300", "opacity-50"],
      ...
      {/* All main dashboard content wrapped in padding */}
      <div className="relative z-20 px-4 sm:px-6 lg:px-8">
        {/* Welcome */}
        <div className="text-center text-black p-6 mb-10 max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold">Welcome back, {user.name}!</h1>
          <p className="text-md mt-1">Ready to crush your fitness goals today?</p>
        </div>

        {/* Stats */}
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 max-w-7xl mx-auto mb-10">
        ...
        {monthlySpendData.length > 0 && (
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 shadow max-w-7xl mx-auto mb-10">
        ...
        {/* Session Lists */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-7xl mx-auto pb-12">
...
const StatCard = ({ icon, title, value, description }) => (
  <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 shadow hover:shadow-md transition">
...
const SessionList = ({ title, sessions, color }) => (
  <div className="bg-gray-50 border border-gray-200 rounded-xl p-5 shadow">
